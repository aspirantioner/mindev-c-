...
public:
     ...
     * @return
     */
    inline virtual std::string& GetTopPrefix(){return this->topPrefix;}
    /**
     * SetTopPrefix 设置顶级前缀
     * @param topPrefix
     */
     ...
     * @return
     */
    inline virtual std::string& GetModuleName(){return this->moduleName;}
    /**
     ...
     * @return
     */
    inline virtual std::string& GetAction(){return this->action;}
    /**
     * SetAction 设置命令动作
     * @param action
     */
     ...
     * @return
     */
    inline virtual ControlParameters& GetParameters(){return this->parameters;}
    /**
