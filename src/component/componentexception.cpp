#include "mindev/include/componentexception.h"

namespace mindev::component{
    int ComponentException::WireEncode(mindev::encoding::Encoder& encoder){
    ...
    bool ComponentException::WireDecode(mindev::encoding::Block& block){
