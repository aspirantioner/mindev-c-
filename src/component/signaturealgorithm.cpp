#include "mindev/include/signaturealgorithm.h"

namespace mindev::component{
    int SignatureAlgorithm::WireEncode(mindev::encoding::Encoder& encoder){
    ...
    bool SignatureAlgorithm::WireDecode(mindev::encoding::Block& block){
