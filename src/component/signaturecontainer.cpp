#include "mindev/include/signaturecontainer.h"

namespace mindev::component{
    int SignatureContainer::WireEncode(mindev::encoding::Encoder& encoder){
    ...
    bool SignatureContainer::WireDecode(mindev::encoding::Block& block){
