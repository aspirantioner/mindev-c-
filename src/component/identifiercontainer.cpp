#include "mindev/include/identifiercontainer.h"

namespace mindev::component{
    int IdentifierContainer::WireEncode(mindev::encoding::Encoder& encoder){
    ...
    bool IdentifierContainer::WireDecode(mindev::encoding::Block& block){
